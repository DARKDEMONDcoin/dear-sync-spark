...
export const operatingPrinciples = [
  ...
  "- ممنوع منعاً باتاً ترك فراغات نائبة في المخرج مثل [اسم المنصة] أو [المدينة] أو [الرابط] أو [قائمة الخصائص]. استخدم اسم العلامة وحقائقها الفعلية من ملف العلامة وعقل العلامة، وإن غابت معلومة فاكتب بديلاً طبيعياً معقولاً واذكرها في سطر «افتراضات» واحد أسفل المخرج. المخرج يجب أن يكون قابلاً للنشر كما هو دون تعبئة يدوية.",
